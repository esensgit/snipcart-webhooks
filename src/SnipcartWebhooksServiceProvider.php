...
use Esensdesign\SnipcartWebhooks\SnipcartWebhooksConfigRepository as ConfigRepository;
...
class SnipcartWebhooksServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        Route::macro('snipcart', function (string $url, string $name = 'default') {
            Route::post($url, '\Esensdesign\SnipcartWebhooks\SnipcartWebhooksController')->name("snipcart-webhooks-{$name}")->withoutMiddleware([VerifyCsrfToken::class]);
        });
